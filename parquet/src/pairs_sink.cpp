...
std::shared_ptr<arrow::Schema> pairs_sink_t::schema() {
  ...
  auto field_vector = arrow::FieldVector{
      ...
      arrow::field(std::string{model::pair_t::c_base}, arrow::utf8(), false),
      arrow::field(std::string{model::pair_t::c_cost_min}, arrow::float64(),
                   false),
      arrow::field(std::string{model::pair_t::c_cost_precision}, arrow::int64(),
                   false),
      arrow::field(std::string{model::pair_t::c_has_index}, arrow::boolean(),
                   false),
      arrow::field(std::string{model::pair_t::c_margin_initial},
                   arrow::float64(), true),
      arrow::field(std::string{model::pair_t::c_marginable}, arrow::boolean(),
                   false),
      arrow::field(std::string{model::pair_t::c_position_limit_long},
                   arrow::int64(), true),
      arrow::field(std::string{model::pair_t::c_position_limit_short},
                   arrow::int64(), true),
      arrow::field(std::string{model::pair_t::c_price_increment},
                   arrow::float64(), false),
      arrow::field(std::string{model::pair_t::c_price_precision},
                   arrow::int64(), false),
      arrow::field(std::string{model::pair_t::c_qty_increment},
                   arrow::float64(), false),
      arrow::field(std::string{model::pair_t::c_qty_min}, arrow::float64(),
                   false),
      arrow::field(std::string{model::pair_t::c_qty_precision}, arrow::int64(),
                   false),
      arrow::field(std::string{model::pair_t::c_quote}, arrow::utf8(), false),
      arrow::field(std::string{model::pair_t::c_status}, arrow::int8(), false),
      arrow::field(std::string{model::pair_t::c_symbol}, arrow::utf8(), false),
  };
