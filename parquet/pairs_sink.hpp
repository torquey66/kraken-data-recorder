...
struct pairs_sink_t final {
 ...
 private:
  ...
  arrow::StringBuilder m_cost_min_builder;
  ...
  arrow::StringBuilder m_price_increment_builder;
  arrow::Int64Builder m_price_precision_builder;
  arrow::StringBuilder m_qty_increment_builder;
  arrow::StringBuilder m_qty_min_builder;
